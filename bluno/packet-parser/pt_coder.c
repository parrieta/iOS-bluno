...
char write_TL(tlv_tag_t tag, tlv_len_t len, app_consume_bytes_b cb, void *app_key, uint8_t constructed) {
    uint8_t buf[32] ;
    uint8_t size = 0 ;
...
char write_tags(
    ...
    tlv_tag_t tag,
    app_consume_bytes_b consume_bytes_cb,
    void *app_key
) {
...
enc_rval_t encode_primitive(type_descriptor_t *td, void *sptr, char tag_mode, tlv_tag_t tag, app_consume_bytes_b cb, void *app_key) {
    enc_rval_t erval ;
...
enc_rval_t encode(type_descriptor_t *type_descriptor, void *struct_ptr, app_consume_bytes_b consume_bytes, void *app_key) {
